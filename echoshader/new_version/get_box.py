...
def get_lasso_stream(source_pic,
        ...
        lasso_stream = holoviews.streams.Lasso(
            ...
            geometry=numpy.array(
                [[source_pic.lbrt[0], source_pic.lbrt[0], source_pic.lbrt[2], source_pic.lbrt[2]],
                 [source_pic.lbrt[1], source_pic.lbrt[3], source_pic.lbrt[1], source_pic.lbrt[3]]]
