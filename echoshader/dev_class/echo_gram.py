...
class Echogram(param.Parameterized):
    ...
    def _sync_widget(self):
        ...
        # DatetimeRangeSlider doestn't exist in panel ( v0.13.1, 2022-7-30 )
    ...
    def view(self):
        ...
        self.bounds = holoviews.DynamicMap(lambda bounds: holoviews.Bounds(
            bounds).opts(line_width=2, line_color='white'),
                                           streams=[self.box])
...
def erase_error():
    return panel.pane.HTML('''<script>code_show_err=false; 
