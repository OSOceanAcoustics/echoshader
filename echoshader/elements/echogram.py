...
class Echogram:
    ...
    def _tricolor_echogram_plot(self):
        ...
        rgb_map = {}
        rgb_map[self.channel[0]] = "R"
        rgb_map[self.channel[1]] = "G"
        rgb_map[self.channel[2]] = "B"

        echogram = Echogram.tricolor_echogram(
            MVBS_ds,
    ...
    def _echogram_plot(self):
        ...
        for channel in self.channel:
            echogram = Echogram.single_echogram(
                MVBS_ds,
                channel,
                self.colormap.value,
                self.Sv_range_slider.value,
    ...
    def tricolor_echogram(
        ...
        for ch, color in rgb_map.items():
            rgb_ch[color] = Echogram.convert_to_color(
